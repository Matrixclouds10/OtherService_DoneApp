            ...
            Container(
              ...
              child: ListAnimator(
                children: [
                  ...
                  Padding(
                    padding:
                        EdgeInsets.symmetric(horizontal: kScreenPaddingLarge.w),
                    child: CustomButton(
                      title: LocaleKeys.joinOurWorld.tr(),
                      onTap: () =>
                          NavigationService.push(RoutesServices.servicesRegisterScreen),
                    ),
                  ),
                  Padding(
                    padding:
                  ...
                  VerticalSpace(kScreenPaddingNormal.h),
                  // GestureDetector(
                  //     onTap: () => NavigationService.push(RoutesServices.servicesHomeScreen),
                  //     child: CustomText(
